...
Original file is located at
    https://colab.research.google.com/drive/1mca057gP3Y1-nSqrLRs6gsmUUewZosH8
"""
...
for lr in learning_rates:
  for reg in regularization_strengths:
    ...
    train_acc = compute_accuracy(y_train, svm.predict(X_train_feats))

    val_acc = compute_accuracy(y_val, svm.predict(X_val_feats))
